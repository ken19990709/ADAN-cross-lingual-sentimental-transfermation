...
def train():
    ...
    en_embedding,en_embedding="None","None" #随机初始化词向量
...
def evaluate(epoch=9):
    ...
    F_name="model_no_embedding_train/netF_epoch_%d.pth"%(epoch)
    P_name="model_no_embedding_train/netP_epoch_%d.pth"%(epoch)
    Q_name="model_no_embedding_train/netQ_epoch_%d.pth"%(epoch)
